...
export class RequestjobApi extends BaseLoopBackApi {
   ...
   *  - `success` – `{object}` - 
   */
  public getAllJobs(aggregate: any = [], skip:number = 0, limit:number = 10, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Requestjobs/getAllJobByAdmin";
    let _routeParams: any = {};
    let _postBody: any = {};
    let _urlParams: any = {};
    if (typeof aggregate !== 'undefined' && aggregate !== null) _urlParams.aggregate = aggregate;
   ...
   *  - `success` – `{object}` - 
   */
  public getMeJobs(customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Requestjobs/getMeJobs";
    let _routeParams: any = {};
    let _postBody: any = {};
    let _urlParams: any = {};
    let result = this.request(_method, _url, _routeParams, _urlParams, _postBody, null, customHeaders);
   ...
   *  - `success` – `{object}` - 
   */
  public vendorAssign(requestjobId: any, vendorId: any, customHeaders?: Function): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Requestjobs/vendorAssign";
    let _routeParams: any = {};
    let _postBody: any = {
      data: {
  ...
  public reassignJob(requestjobId: any, startDate: any, endDate: any, customHeaders?: Function): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Requestjobs/reassignJob";
    let _routeParams: any = {};
    let _postBody: any = {
      data: {
        requestjobId: requestjobId,
  ...
  public sendMessage(requestjobId: any, customHeaders?: Function): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Requestjobs/sendMessage";
    let _routeParams: any = {};
    let _postBody: any = {
      data: {
        requestjobId: requestjobId    
   ...
   *  - `success` – `{object}` - 
   */
  public vendorJobs(vendorId: any, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
   ...
   *  - `success` – `{object}` - 
   */
  public vendorAllJobs(vendorId: any, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
   ...
   *  - `success` – `{object}` - 
   */
  public vendorAcceptorCancel(req: any = {}, requestjobId: any = {}, status: any, customHeaders?: Function): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
   ...
   *  - `success` – `{object}` - 
   */
  public engineerAccept(req: any = {}, requestjobId: any, customHeaders?: Function): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
   ...
   *  - `success` – `{object}` - 
   */
  public engineerSchedule(req: any = {}, requestjobId: any = {}, eStartDate: any = {}, eEndDate: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
   ...
   *  - `success` – `{object}` - 
   */
  public startJob(requestjobId: any = {}, req: any = {}, otp: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Requestjobs/startJob";
    let _routeParams: any = {};
    let _postBody: any = {
      data: {
        otp: otp
   ...
   *  - `success` – `{object}` - 
   */
  public generateBill(requestjobId: any, req: any = {}, res: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Requestjobs/generateBill";
    let _routeParams: any = {};
    let _postBody: any = {
      data: {
        res: res
   ...
   *  - `success` – `{object}` - 
   */
  public pickProduct(requestjobId: any, req: any = {}, res: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Requestjobs/pickProduct";
    let _routeParams: any = {};
    let _postBody: any = {};
    let _urlParams: any = {};
    if (typeof requestjobId !== 'undefined' && requestjobId !== null) _urlParams.requestjobId = requestjobId;
   ...
   *  - `success` – `{object}` - 
   */
  public partResponse(addPart: any = {}, requestjobId: any, customHeaders?: Function): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
   ...
   *  - `success` – `{object}` - 
   */
  public cancelJob(req: any = {}, reason: any = {}, comment: any = {}, realm: any = {}, requestjobId: any, customHeaders?: Function): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
   ...
   *  - `success` – `{object}` - 
   */
  public completeJob(requestjobId: any = {}, customerId: any = {}, engineerId: any = {}, isPaymentDone: any = {}, modeOfPayment: any = {}, comment: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Requestjobs/completeJob";
    let _routeParams: any = {};
    let _postBody: any = {
      data: {
   ...
   *  - `success` – `{object}` - 
   */
  public getJobsAdmin(filter: LoopBackFilter = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Requestjobs/getJobsAdmin";
    let _routeParams: any = {};
    let _postBody: any = {};
    let _urlParams: any = {};
